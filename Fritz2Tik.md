...
The Fritz!Box (v7.29) provides an API to quering data from the router:
...
Refrence: [DHCP Server / Leases](https://wiki.mikrotik.com/wiki/Manual:IP/DHCP_Server#Leases)
...
See: https://github.com/stedolan/jq/issues/708#issuecomment-75394871
...
Reference: [Setting static DNS record for each DHCP lease](https://wiki.mikrotik.com/wiki/Setting_static_DNS_record_for_each_DHCP_lease)

## Shell script

The [shell scrip](scripts/fritz2tik.sh) combines both funtcions and takes a given file as argument.
